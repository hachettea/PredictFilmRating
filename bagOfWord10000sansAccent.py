...
print("test")
vectorizer = CountVectorizer(strip_accents='unicode',min_df=100, stop_words=stopwords.words('french'), dtype=bool)
...
print("test")
vectorizer = CountVectorizer(vocabulary=cv_dataframe,strip_accents='unicode',min_df=100, stop_words=stopwords.words('french'), dtype=bool)
# here's our sentences
