...
listeCommentaire = data['commentaire'][:20000].astype(str)
listeNote = data['note'][:20000].astype(str)
...
tfidfvectorizer = TfidfVectorizer(strip_accents='unicode',min_df=10, stop_words=stopwordsFR)
...
# TODO try avec une noramlisation
print("test")
...
tfidfvectorizer = TfidfVectorizer(strip_accents='unicode',min_df=10,stop_words= stopwordsFR,vocabulary=x_smote)
...
print("fileencodding")
f = open("fichier25.txt", "w",encoding="ascii")
