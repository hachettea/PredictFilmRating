...
tfidfvectorizer = TfidfVectorizer(strip_accents='unicode',min_df=10,max_df=500, stop_words=stopwordsFR)
...
tfidfvectorizer = TfidfVectorizer(strip_accents='unicode',min_df=10,max_df=500,stop_words= stopwordsFR,vocabulary=x_smote)
