...
print("test")
vectorizer = CountVectorizer(min_df=25, stop_words=stopwords.words('french'), dtype=bool)
...
print("test")
vectorizer = CountVectorizer(vocabulary=cv_dataframe,min_df=25, stop_words=stopwords.words('french'), dtype=bool)
# here's our sentences
