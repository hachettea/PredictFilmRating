...
tfidfvectorizer = TfidfVectorizer(min_df=100, stop_words= stopwords.words('french'))
...
print("transform")
# vectorized_data = vectorizer.fit_transform(listeCommentaire)
tfidfvectorizer = TfidfVectorizer(min_df=100,stop_words= stopwords.words('french'),vocabulary=tfIDF)
